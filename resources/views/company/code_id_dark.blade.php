...
<body class="vh-100">
    ...
    <div class="input-group mb-3 w-100" dir="ltr">
        <input type="text" class="form-control text-white custom-input" style=" border-radius: 8px 0 0 8px; " id="myInput" value="{{ $code }}" >
        <button  class="btn " style="background-color: transparent; border: 1px solid var(--border-color); height: 45px !important; border-radius: 0 8px 8px 0; width: 60px; " type="button" onclick="copyText(document.getElementById('myInput'));"><i class="text-white fas fs-5 fa-clone fa-rotate-180"></i></button>
      </div>
